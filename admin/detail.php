...
<table border="1" width="100%">
    ...
    <?
		$sql1=mysql_query("select * from thiep inner join  hondonct on thiep.MaThiep=hondonct.MaThiep where hondonct.MaHD='$mahd'");
		$stt=0;
    ...
    <tr class="row">
    	<td><? echo $stt ?></td>
        <td><? echo ($r['MaThiep'])?></td>
        <td><? echo ($r['TenThiep'])?></td>
